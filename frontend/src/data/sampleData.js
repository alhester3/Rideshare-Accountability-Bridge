...
export const users = [
  ...
  { id: "d1", name: "Alex", role: "Driver/Courier", status: "Active", rating: 4.8, zone: "Downtown", lastActivity: "2026-04-07" },
  { id: "d2", name: "Maria", role: "Driver/Courier", status: "Active", rating: 4.6, zone: "Suburban", lastActivity: "2026-04-07" },
  { id: "d3", name: "James", role: "Driver/Courier", status: "Active", rating: 4.9, zone: "Airport", lastActivity: "2026-04-06" },
  { id: "d4", name: "Priya", role: "Driver/Courier", status: "Flagged", rating: 4.5, zone: "Midtown", lastActivity: "2026-04-05" },
  { id: "d5", name: "Ken", role: "Driver/Courier", status: "Active", rating: 4.7, zone: "Campus", lastActivity: "2026-04-05" },
  { id: "d6", name: "Ivy", role: "Driver/Courier", status: "Active", rating: 4.4, zone: "Uptown", lastActivity: "2026-04-04" },
  { id: "d7", name: "Mateo", role: "Driver/Courier", status: "Active", rating: 4.8, zone: "West Side", lastActivity: "2026-04-03" },
  { id: "d8", name: "Fatima", role: "Driver/Courier", status: "Active", rating: 4.7, zone: "East Side", lastActivity: "2026-04-03" },
...
export const decisions = [
  ...
  { id: "dec-1004", userId: "d1", type: "Driver Match", outcome: "Missed Trip", timestamp: "2026-04-06T08:25:00Z", status: "Open", factors: ["Proximity to Pickup", "Driver Rating", "Current Availability", "Area Demand"], excluded: ["Race", "Gender", "Age"], summary: "Trip offered to a closer active driver." },
...
export const ridesAndTrips = [
  ...
  { id: "trip-7001", userId: "d1", decisionId: "dec-1004", date: "2026-04-06", earnings: 19.4, distance: 5.2, status: "Missed", demand: "High" },
  { id: "trip-7002", userId: "d1", decisionId: "dec-1005", date: "2026-04-05", earnings: 34.1, distance: 11.2, status: "Completed", demand: "Medium" },
  { id: "trip-7003", userId: "d2", decisionId: "dec-1006", date: "2026-04-07", earnings: 24.4, distance: 7.2, status: "Completed", demand: "High" },
  { id: "trip-7004", userId: "d3", decisionId: "dec-1007", date: "2026-04-07", earnings: 27.4, distance: 6.4, status: "Completed", demand: "High" },
  { id: "trip-7005", userId: "d1", decisionId: "dec-1004", date: "2026-04-07", earnings: 0, distance: 0, status: "Missed", demand: "High" },
